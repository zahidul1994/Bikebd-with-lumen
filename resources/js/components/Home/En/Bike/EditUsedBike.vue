<template>
    ...
    <div class="card card-info mt-5 container bg-warning">
        <div class="card-header">
            <h3 class="card-title center">Used Bike Edit </h3>
        </div>
        ...
        <form role="form" class="" @submit.prevent="Editpostbike" enctype="multipart/form-data">
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-10">
                   ...
                   <div class="form-group row">
                    <label for="usedtime" class="col-sm-2 col-form-label">Used time</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="kilometerrun" class="col-sm-2 col-form-label">Kilometers run (km)</label>
                    <div class="col-sm-10">
                        <input v-model="form.kilometerrun" type="number" class="form-control"
                            :class="{ 'is-invalid': form.errors.has('kilometerrun') }" id="kilometerrun" placeholder="Kilometerrun">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-info">Update Post</button>
                  <router-link to="/en/bikepostlist" class="btn btn-default ">Cancel</router-link>
            </div>
            <!-- /.card-footer -->
        </form>
    </div>
        ...
        methods: {
            Editpostbike() {
                if(this.form.bikeimage.length==0){
                 ...
                 else if(this.form.bikeimage.length>=5){
                  ...
                  console.log(this.form);
                    ...
                    .catch(response => {
                        console.log(response);
                        [toastr.warning("Sorry Try Again55"), ]
                    });
            }
            },

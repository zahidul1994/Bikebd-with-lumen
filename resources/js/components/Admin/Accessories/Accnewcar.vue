<template>
    ...
    <div class="card card-info mt-5 container bg-info">
        <div class="card-header">
            <h2 class="card-title center"><Strong>Accessories</Strong></h2>
        </div>
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" class="" @submit.prevent="accenewbike" enctype="multipart/form-data">
            <div class="card-body">
               ...
               <div class="form-group row">
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input v-model="form.kilometer_run" type="number" class="form-control"
                            :class="{ 'is-invalid': form.errors.has('kilometer_run') }" id="kilometer_run" placeholder="kilometer_run">
                        <has-error :form="form" field="kilometer_run"></has-error>
                    </div>
                 ...
                 <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input v-model="form.used" type="date" class="form-control"
                            :class="{ 'is-invalid': form.errors.has('used') }" id="used" placeholder="Kilometers">
                        <has-error :form="form" field="used"></has-error>
                    </div>
              ...
              <!-- <div class="form-group row">
                ...
                <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                        ...
                        <textarea v-model="form.description" style="resize:both" class="form-control" placeholder="Description"></textarea>
    ...
    export default {
        ...
        methods: {
            accenewbike() {
                ...
                this.form.post("/en/accenewbike", this.form)
                    .then(response => {

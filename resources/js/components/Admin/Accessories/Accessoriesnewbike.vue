    ...
    <div class="card card-info mt-5 container bg-warning">
        ...
        <form role="form" class="" @submit.prevent="accnewbikecreate" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="col-sm-10">
                    <select  :class="{'is-invalid' :form.errors.has('accessoriestypename')}" id="accessoriestypename"  v-model="form.accessoriestypename" class="form-control" >
                        <option disabled value="">Select One</option>
                      <option v-for="accessoriestypename in accessoriestypevue" :value="accessoriestypename._id">{{accessoriestypename.accessoriesname}}</option>
...
import VueUploadMultipleImage from 'vue-upload-multiple-image'
  ...
  components: {
    VueUploadMultipleImage
        ...
        mounted() {
            axios
                .get('http://127.0.0.1:8000/en/accessoreistypename')
                .then(response => {
                    (this.accessoriestypevue = response.data.accessoriestype)

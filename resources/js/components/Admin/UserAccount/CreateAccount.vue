               ...
               <form role="form" @submit.prevent="addAdmin" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select   class="form-control" :class="{'is-invalid' :form.errors.has('accounttype')}" v-model="form.accounttype">
                      ...
                      <option   v-for="accountname in allAccounttypes" :value="accountname._id">{{accountname.accounttype}}</option>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Submit</button>
                   <router-link to="/superadmin/addadmin" class="btn btn-default ">Cancel</router-link>
               </div>
            </form>
                </div>

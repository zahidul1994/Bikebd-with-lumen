               ...
               <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select  :class="{'is-invalid' :form.errors.has('bikeversion')}" id="bikeversion"  v-model="form.bikeversion" class="form-control" >
                        <option disabled value="">Select One</option>
                      <option v-for="bikeversionname in bikeversion" :value="bikeversionname._id" >{{bikeversionname.bikeversion}}</option>
                ...
                <div class="col-sm-10">
                    <select  :class="{'is-invalid' :form.errors.has('bikemodelyear')}" id="bikemodelyear"  v-model="form.bikemodelyear" class="form-control" >
                        <option disabled value="">Select One</option>
                      <option v-for="bikemodelyearname in modelyear" :value="bikemodelyearname._id" >{{bikemodelyearname.modelyear}}</option>
